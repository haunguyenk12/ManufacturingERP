...
- [x] Inventory Lot list/detail/status có OpenAPI và business rules. *(`C2-2`, 2026-08-06 — xem `docs/capstone2-api-gap-response.md §11`)*
- [x] Audit list/detail có OpenAPI. *(`C2-1`, 2026-08-06 — xem `docs/capstone2-api-gap-response.md §10`)*
